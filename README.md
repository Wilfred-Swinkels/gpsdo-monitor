...
controller en de I2C-ADC-driver staan er, plus een klein CLI-smoke-test-
programma zonder UI. De echte QML-app moet nog gebouwd worden.
...
./build/gpsdo_test_cli --fll /dev/ttyUSB0 --adc /dev/i2c-1
```

Print live de FLL-statusregels en/of ADC-spanningen naar stdout — handig om
de bekabeling en drivers te verifiëren voordat er een UI omheen staat.
